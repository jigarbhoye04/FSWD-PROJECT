    ...
    <section class="hero bg-image" data-image-src="images/img/main.jpeg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Food Delivery & Restaurant </h1>
                ...
                <div class="banner-form">
                    <form class="form-inline">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="Search Items">
                            </div>
                        </div>
            ...
            <div class="row top-footer">
                ...
                <div class="col-xs-12 col-sm-2 pages color-gray">
                    ...
                    <ul>
                        ...
                        <li><a href="http://localhost/Online_Food_Order/your_orders.php">Your Orders</a> </li>
                        <li><a href="http://localhost/Online_Food_Order/your_orders.php">Add to cart</a> </li>
                    </ul>
                </div>
            ...
            <div class="bottom-footer">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 address color-gray">
                        <h5>Address</h5>
                        <p>B/H Balaji Temple Opp. Nirma University 123490</p>
                        <h5>Phone: <a href="tel:+0809106663222">080 9106663 222</a></h5>
                    </div>
                    <div class="col-xs-12 col-sm-5 additional-info color-gray">
                        <h5>Addition informations</h5>
                        <p>This is a Simple Food ordering website made using simple html, css and php.</p>
                        <a href="https://github.com/jigarbhoye04">GitHub</a>
                    </div>
                </div>
            </div>
            <!-- bottom footer ends -->
